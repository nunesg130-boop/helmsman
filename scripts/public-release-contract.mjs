...
assert.equal(packageJson.version, "1.0.4", "the public release must use the selected SemVer");
...
assert.match(readme, /^# Helmsman v1[.]0[.]4$/mu, "the public README must identify the stable release");
assert.match(readme, /`v1[.]0[.]4` Git tag[\s\S]*?version, `latest`, and full-commit image tags/iu);
