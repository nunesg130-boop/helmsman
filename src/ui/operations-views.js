    ...
    <div class="page operations-page infrastructure-page infrastructure-bento ${pageStateClass}" id="infrastructure-overview">
      ...
      ${snapshot.targets.length ? `<section class="operations-panel infrastructure-overview-card infrastructure-signals infrastructure-signals-card" aria-labelledby="infrastructure-signals-title">
        ...
        <dl class="infrastructure-signals__grid">
          <div class="infrastructure-signal-row is-neutral"><dt><span class="infrastructure-signal-row__mark">${svgIcon("server")}</span><span class="infrastructure-signal-row__copy"><span class="infrastructure-signal-row__label">Nodes online</span><small>Across discovered environments</small></span></dt><dd><strong class="infrastructure-signal-row__value" data-infrastructure-metric="nodes">${escapeOperationsHtml(nodes)}</strong>${svgIcon("chevron")}</dd></div>
          <div class="infrastructure-signal-row is-neutral"><dt><span class="infrastructure-signal-row__mark">${svgIcon("server")}</span><span class="infrastructure-signal-row__copy"><span class="infrastructure-signal-row__label">Guests running</span><small data-infrastructure-detail="guests">${escapeOperationsHtml(guestDetail)}</small></span></dt><dd><strong class="infrastructure-signal-row__value" data-infrastructure-metric="guests-running-signal">${infrastructureMetric(snapshot.metrics.guestsRunning)}</strong>${svgIcon("chevron")}</dd></div>
          <div class="infrastructure-signal-row is-neutral"><dt><span class="infrastructure-signal-row__mark">${svgIcon("refresh")}</span><span class="infrastructure-signal-row__copy"><span class="infrastructure-signal-row__label">Average node CPU</span><small>Weighted across reporting nodes</small></span></dt><dd><strong class="infrastructure-signal-row__value" data-infrastructure-metric="node-cpu">${storageMetric(snapshot.metrics.nodeCpuPercent)}</strong>${svgIcon("chevron")}</dd></div>
          <div class="infrastructure-signal-row is-neutral"><dt><span class="infrastructure-signal-row__mark">${svgIcon("server")}</span><span class="infrastructure-signal-row__copy"><span class="infrastructure-signal-row__label">Node memory</span><small data-infrastructure-detail="node-memory">${snapshot.metrics.nodeMemoryUsedBytes === null ? "Aggregate use" : `${bytesMetric(snapshot.metrics.nodeMemoryUsedBytes)} used`}</small></span></dt><dd><strong class="infrastructure-signal-row__value" data-infrastructure-metric="node-memory">${ratioMetric(snapshot.metrics.nodeMemoryUsedBytes, snapshot.metrics.nodeMemoryTotalBytes)}</strong>${svgIcon("chevron")}</dd></div>
          <div class="infrastructure-signal-row is-${storageTone}"><dt><span class="infrastructure-signal-row__mark">${svgIcon("server")}</span><span class="infrastructure-signal-row__copy"><span class="infrastructure-signal-row__label">Aggregate storage use</span><small data-infrastructure-detail="storage">${escapeOperationsHtml(storageDetail)}</small></span></dt><dd><strong class="infrastructure-signal-row__value" data-infrastructure-metric="storage">${storageMetric(snapshot.metrics.storagePercent)}</strong>${svgIcon("chevron")}</dd></div>
          <div class="infrastructure-signal-row ${snapshot.metrics.failedTasks ? "is-danger" : "is-neutral"}"><dt><span class="infrastructure-signal-row__mark">${svgIcon(snapshot.metrics.failedTasks ? "x" : "check")}</span><span class="infrastructure-signal-row__copy"><span class="infrastructure-signal-row__label">Failed tasks</span><small>Current bounded window</small></span></dt><dd><strong class="infrastructure-signal-row__value" data-infrastructure-metric="failed-tasks">${infrastructureMetric(snapshot.metrics.failedTasks)}</strong>${svgIcon("chevron")}</dd></div>
          <div class="infrastructure-signal-row ${snapshot.metrics.backupIssues ? "is-warning" : "is-neutral"}"><dt><span class="infrastructure-signal-row__mark">${svgIcon(snapshot.metrics.backupIssues ? "more" : "check")}</span><span class="infrastructure-signal-row__copy"><span class="infrastructure-signal-row__label">Backup issues</span><small data-infrastructure-detail="backups">${escapeOperationsHtml(backupDetail)}</small></span></dt><dd><strong class="infrastructure-signal-row__value" data-infrastructure-metric="backup-issues">${infrastructureMetric(snapshot.metrics.backupIssues)}</strong>${svgIcon("chevron")}</dd></div>
        </dl>
      </section>` : ""}
