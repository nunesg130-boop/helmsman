...
The supported Helmsman v1.3.0 deployment uses the GitHub Release
...
Pushing the Git tag `v1.3.0` runs the Node contracts and Linux AMD64/ARM64 smoke
...
## v1.3.0 Obsidian Glass visual release

v1.3.0 applies the compact near-black Obsidian Glass design system to every
...
continue to use Helmsman's existing normalized application model. Desktop,
tablet, and mobile now share the same smoked-glass surfaces, graphite rules,
restrained green status emphasis, and accessible full-width notifications.
